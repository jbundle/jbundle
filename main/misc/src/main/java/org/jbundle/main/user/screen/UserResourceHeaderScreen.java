...
public class UserResourceHeaderScreen extends HeaderScreen
{
     ...
     */
    public UserResourceHeaderScreen(ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
