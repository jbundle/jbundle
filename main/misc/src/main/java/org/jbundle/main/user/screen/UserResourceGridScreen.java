 ...
 *  UserResourceGridScreen - .
 */
public class UserResourceGridScreen extends GridScreen
{
    /**
     * Default constructor.
     */
    public UserResourceGridScreen()
    {
        super();
    }
    /**
     ...
     */
    public UserResourceGridScreen(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
