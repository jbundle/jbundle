 ...
 *  UserGroupGridScreen - .
 */
public class UserGroupGridScreen extends GridScreen
{
    /**
     * Default constructor.
     */
    public UserGroupGridScreen()
    {
        super();
    }
    /**
     ...
     */
    public UserGroupGridScreen(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
