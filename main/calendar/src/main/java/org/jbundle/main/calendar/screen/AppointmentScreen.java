...
public class AppointmentScreen extends Screen
{
    ...
    public void setupSFields()
    {
        ...
        this.getRecord(Appointment.APPOINTMENT_FILE).getField(Appointment.HIDDEN).setupDefaultView(this.getNextLocation(ScreenConstants.NEXT_LOGICAL, ScreenConstants.ANCHOR_DEFAULT), this, ScreenConstants.DEFAULT_DISPLAY);
        this.getRecord(Appointment.APPOINTMENT_FILE).getField(Appointment.PROPERTIES).setupDefaultView(this.getNextLocation(ScreenConstants.NEXT_LOGICAL, ScreenConstants.ANCHOR_DEFAULT), this, ScreenConstants.DEFAULT_DISPLAY);
    }
