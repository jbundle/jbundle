...
public class AnnivMasterGridScreen extends GridScreen
{
     ...
     */
    public AnnivMasterGridScreen(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
