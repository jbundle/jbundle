     ...
     implements MessageStatusModel
{
    ...
    public static final int kMessageStatusLastField = kIcon;
    public static final int kMessageStatusFields = kIcon - DBConstants.MAIN_FIELD + 1;
     ...
     * Constructor.
     */
    public MessageStatus(RecordOwner screen)
    {
        this();
        this.init(screen);
    }
    ...
    public static final String kMessageStatusFile = "MessageStatus";
    /**
     * Get the table name.
     */
    public String getTableNames(boolean bAddQuotes)
    {
        return (m_tableName == null) ? Record.formatTableNames(kMessageStatusFile, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
    ...
    public BaseField setupField(int iFieldSeq)
    {
        ...
        if (field == null)
        {
            ...
            if (field == null) if (iFieldSeq < kMessageStatusLastField)
    ...
    public KeyArea setupKey(int iKeyArea)
    {
        ...
        if (keyArea == null) if (iKeyArea < kMessageStatusLastKey)
        {
