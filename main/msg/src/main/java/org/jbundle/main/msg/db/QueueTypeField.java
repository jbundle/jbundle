...
/**
 *  QueueTypeField - Queue type.
 */
public class QueueTypeField extends StringPopupField
{
    /**
     * Default constructor.
     */
    public QueueTypeField()
    {
        super();
    }
    /**
     ...
     */
    public QueueTypeField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
