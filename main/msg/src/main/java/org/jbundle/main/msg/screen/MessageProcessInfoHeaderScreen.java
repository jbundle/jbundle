...
public class MessageProcessInfoHeaderScreen extends HeaderScreen
{
     ...
     */
    public MessageProcessInfoHeaderScreen(ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
