...
public class MemoryObjectTest extends ObjectTest
{
    /**
      *Creates new TestAll
      */
    public MemoryObjectTest(String strTestName)
    {
        super(strTestName);
    }
    /**
    ...
    public static Test suite()
    {
        ...
        suite.addTest(new MemoryObjectTest("testDatabase"));
    ...
    public void setUp()
    {
        if (vet == null)
        {
            String[] args = {"remote=Memory", "local=Memory", "table=Memory"};
