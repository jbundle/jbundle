 ...
 *  TestDetailDetail - .
 */
public class TestDetailDetail extends ReportScreen
{
    /**
     * Default constructor.
     */
    public TestDetailDetail()
    {
        super();
    }
    /**
     ...
     */
    public TestDetailDetail(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
