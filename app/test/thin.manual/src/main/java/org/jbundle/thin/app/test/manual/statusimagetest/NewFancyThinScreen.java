 ...
 */
public class NewFancyThinScreen extends JScreen
{
     ...
     *  OrderEntry Class Constructor.
     */
    public NewFancyThinScreen(Object parent, Object obj)
    {
        this();
    ...
    public boolean addSubPanels(Container parent)
    {
        ...
        return super.addSubPanels(panelRight);
    }
    /**
    ...
    public Converter getFieldForScreen(int iIndex)
    {
        ...
        Converter field = super.getFieldForScreen(iIndex);
        if (field == SKIP_THIS_FIELD)
            return field;
        if (field == null)
            return null;
        
        if ("TestMemo".equalsIgnoreCase(field.getFieldName()))
            m_iMemoLocation = iIndex;
        if ("TestImage".equalsIgnoreCase(field.getFieldName()))
        ...
        field = super.getFieldForScreen(iIndex);
        return field;
    }
    /**
...
//          c.gridx = 3;                            // Column 1
    ...
    public JComponent createScreenComponent(Converter fieldInfo)
    {
        ...
        if ("TestShort".equalsIgnoreCase(fieldInfo.getFieldName()))
        {
            FieldList record = new TestSecond(this);
            RemoteSession remoteSession = null;
//------------------------
	            Application app = this.getBaseApplet().getApplication();
...
//------------------------
            ...
            fieldInfo = new SecondaryRecordConverter(fieldInfo, remoteSession, record, strFieldName, bCacheTable, strIndexValue, null, "1");
            fieldInfo = new ImageConverter(fieldInfo);  // Add this the first time.
            component = new JCellImage(fieldInfo);
            component.setBorder(null);

//          Typically, you don't want another 2ndary, but since this is a memory table who cares.
            strFieldName = "Description";
            fieldInfo = new SecondaryRecordConverter(fieldInfo, remoteSession, record, strFieldName, bCacheTable, strIndexValue, null, "1");
            JComponent component2 = new JFSTextField(fieldInfo);
            component2.setEnabled(false);

            component = new JMultiFieldPanel(fieldInfo, component, component2);
        ...
        if ("TestLong".equalsIgnoreCase(fieldInfo.getFieldName()))
        {
            ...
            FieldList record = new TestSecond(null);
            ...
            String strDesc = "Desc";
            String strFieldName = "Description";
    ...
    {
        return new NewJTestGridScreen(this.getParentObject(), record);
    }
