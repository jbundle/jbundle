 ...
 *  @version 1.0.0.
 */
import org.jbundle.thin.app.test.vet.shared.db.Snake;
 ...
 */
public class JSnakeGridScreen extends JGridScreen
{
     ...
     */
    public JSnakeGridScreen(Object parent, Object record)
    {
        this();
    ...
    {
        return new Snake(null);   // If overriding class didn't set this
    }
    /**
     * Build the list of fields that make up the screen.
     * Override this to create a new record.
