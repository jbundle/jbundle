 ...
 */
public class NewJTestGridScreen extends JGridScreen
{
     ...
     */
    public NewJTestGridScreen(Object parent, Object record)
    {
        this();
    ...
    {
        return new NewTestGridModel(record.getTable());
    }
    /**
    ...
    {
        return new NewFancyThinScreen(this.getParentObject(), record);
    }
}
