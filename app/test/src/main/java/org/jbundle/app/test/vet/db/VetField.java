...
/**
 *  VetField - Popup for Vets.
 */
public class VetField extends ReferenceField
{
    /**
     * Default constructor.
     */
     ...
     */
    public VetField(Record record, String strName, int iDataLength, String strDesc, Object strDefault)
    {
        this();
