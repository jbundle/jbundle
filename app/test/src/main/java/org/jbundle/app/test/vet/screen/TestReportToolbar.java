 ...
 *  TestReportToolbar - .
 */
public class TestReportToolbar extends ReportToolbar
{
    /**
     * Default constructor.
     */
    public TestReportToolbar()
    {
        super();
    }
    /**
     ...
     */
    public TestReportToolbar(ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc)
    {
        this();
