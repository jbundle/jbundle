...
/**
 *  TestBasicScreen - Test basic screen..
 */
public class TestBasicScreen extends Screen
{
    /**
     * Default constructor.
     */
    public TestBasicScreen()
    {
        super();
    }
    /**
     ...
     */
    public TestBasicScreen(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
    ...
    public void addListeners()
    {
        ...
        this.getRecord(TestTable.kTestTableFile).addListener(new ValidateFieldHandler(TestTable.kTestFloat, "21.00", false));
    ...
    public void setupSFields()
    {
        ...
        this.getRecord(TestTable.kTestTableFile).getField(TestTable.kTestReal).setupDefaultView(this.getNextLocation(ScreenConstants.NEXT_LOGICAL, ScreenConstants.ANCHOR_DEFAULT), this, ScreenConstants.DEFAULT_DISPLAY);
