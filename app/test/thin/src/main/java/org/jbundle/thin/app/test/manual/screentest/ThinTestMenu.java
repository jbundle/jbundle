 ...
 */
public class ThinTestMenu extends BaseApplet
{
     ...
     *  OrderEntry Class Constructor.
     */
    public ThinTestMenu(String[] args)
    {
        this();
        this.init(args);
    }
...
//      FieldList record = new org.jbundle.thin.main.Menus(this);  // If overriding class didn't set this
//      this.linkNewRemoteTable(null, record);
    ...
    public static void main(String args[])
    {
        ...
        BaseApplet applet = ThinTestMenu.getSharedInstance();
        if (applet == null)
            applet = new ThinTestMenu(args);
