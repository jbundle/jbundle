...
public class ProjectTaskHeaderScreen extends HeaderScreen
{
     ...
     */
    public ProjectTaskHeaderScreen(ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
