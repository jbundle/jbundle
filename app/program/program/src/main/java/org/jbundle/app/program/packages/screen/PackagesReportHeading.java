...
public class PackagesReportHeading extends HeadingScreen
{
    ...
    public void setupSFields()
    {
        ...
        new SEditText(this.getNextLocation(ScreenConstants.NEXT_LOGICAL, ScreenConstants.ANCHOR_DEFAULT), this, this.getRecord(PackagesReportScreenRecord.kPackagesReportScreenRecordFile).getField(PackagesReportScreenRecord.kJnlpFileID), ScreenConstants.DEFAULT_DISPLAY);
