 ...
 *  PackagesReportToolbar - .
 */
public class PackagesReportToolbar extends ReportToolbar
{
    /**
     * Default constructor.
     */
    public PackagesReportToolbar()
    {
        super();
    }
    /**
     ...
     */
    public PackagesReportToolbar(ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
