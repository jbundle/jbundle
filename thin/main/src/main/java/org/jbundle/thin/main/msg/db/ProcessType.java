...
public class ProcessType extends org.jbundle.thin.base.db.FieldList
    implements org.jbundle.model.main.msg.db.ProcessTypeModel
{
    ...
    public ProcessType(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? ProcessType.PROCESS_TYPE_FILE : super.getTableNames(bAddQuotes);
    }
    /**
