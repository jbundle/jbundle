...
public class MessageStatus extends org.jbundle.thin.base.db.FieldList
{
    ...
    public MessageStatus(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? MessageStatus.MESSAGE_STATUS_FILE : super.getTableNames(bAddQuotes);
    }
    /**
