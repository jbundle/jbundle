...
public class MessageInfoType extends org.jbundle.thin.base.db.FieldList
{
    ...
    public MessageInfoType(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? MessageInfoType.MESSAGE_INFO_TYPE_FILE : super.getTableNames(bAddQuotes);
    }
    /**
