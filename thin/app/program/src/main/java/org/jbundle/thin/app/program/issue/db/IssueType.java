...
public class IssueType extends org.jbundle.thin.base.db.FieldList
{
    ...
    public IssueType(Object recordOwner)
    {
        this();
    ...
    {
        return (m_tableName == null) ? IssueType.ISSUE_TYPE_FILE : super.getTableNames(bAddQuotes);
    }
    /**
