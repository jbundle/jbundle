...
public class HtmlResources extends ListResourceBundle
{
   ...
   static final Object[][] contents = {
    ...
    {"htmlContentStart", "<td valign=\"top\">" + "\n" +
        "<!-- Start Content Area -->"},
    {"htmlDefault", "<hr>" + "\n" +
        "<form action=\"tourapp\" method=\"get\">" + "\n" +
        "<pre>" + "\n" +
    ...
    {"htmlNavMenuDon", "      <tr valign=\"top\">" + "\n" +
        ...
        "        <a href=\"tourapp?menu=\"><img src=\"images/buttons/Home.gif\" align=\"center\" alt=\"Home\" border=\"0\" width=\"16\" height=\"16\" />" + "\n" +
        "                Home</a><br/>" + "\n" +
