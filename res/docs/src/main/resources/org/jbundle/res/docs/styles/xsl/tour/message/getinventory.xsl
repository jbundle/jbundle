...
<xsl:template match="root">
	...
	Please respond to the following availability request:
    ...
    <br/>We are requesting space availability.
	...
	<xsl:if test="header/formReply != ''">
		...
		<br/>
			<xsl:element name="form">
				...
				Hotel availability: <input type="text" name="Availability" size="30" maxlength="30" value="" />
