...
<xsl:template match="root">
	...
	Please respond to the following price request:
    ...
    <br/><b>1.</b> Reply to this message without changing this message or subject and fill in the price on the following line:
