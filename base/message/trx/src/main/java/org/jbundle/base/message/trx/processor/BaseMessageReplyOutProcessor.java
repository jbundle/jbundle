 ...
 */
public class BaseMessageReplyOutProcessor extends BaseInternalMessageProcessor
{

    /**
     * Default constructor.
     */
    public BaseMessageReplyOutProcessor()
    {
        super();
    }
    /**
     * Default constructor.
     */
    public BaseMessageReplyOutProcessor(RecordOwnerParent taskParent, Record recordMain, Map<String, Object> properties)
    {
        this();
