 ...
 */
public class XBaseGridTableScreen extends XBaseGridScreen
{
    /**
     * Constructor.
     */
    public XBaseGridTableScreen()
    {
        super();
    }
    /**
     * Constructor.
     */
    public XBaseGridTableScreen(ScreenField model, boolean bEditableControl)
    {
        this();
