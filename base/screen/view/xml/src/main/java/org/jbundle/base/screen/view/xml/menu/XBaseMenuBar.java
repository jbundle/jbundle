 ...
 */
package org.jbundle.base.screen.view.xml.menu;
 ...
 */
public class XBaseMenuBar extends XBasePanel
{
     ...
     * Constructor.
     */
    public XBaseMenuBar(ScreenField model,boolean bEditableControl)
    {
        this();
