 ...
 *  UserGroupScreen - .
 */
public class UserGroupScreen extends Screen
{
    /**
     * Default constructor.
     */
    public UserGroupScreen()
    {
        super();
    }
    /**
     ...
     */
    public UserGroupScreen(Record record, ScreenLocation itsLocation, BasePanel parentScreen, Converter fieldConverter, int iDisplayFieldDesc, Map<String,Object> properties)
    {
        this();
    ...
    public void setupSFields()
    {
        ...
        this.getRecord(UserGroup.kUserGroupFile).getField(UserGroup.kProperties).setupDefaultView(this.getNextLocation(ScreenConstants.NEXT_LOGICAL, ScreenConstants.ANCHOR_DEFAULT), this, ScreenConstants.DEFAULT_DISPLAY);
    }
