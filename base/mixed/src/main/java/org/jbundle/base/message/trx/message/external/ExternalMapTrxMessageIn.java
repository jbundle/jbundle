 ...
 * @version 
 */
public class ExternalMapTrxMessageIn extends ExternalTrxMessageIn
{
     ...
     */
    public ExternalMapTrxMessageIn() 
    {
        super();
    }
    /**
     ...
     */
    public ExternalMapTrxMessageIn(BaseMessage message, Object objRawMessage)
    {
        this();
