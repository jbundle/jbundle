...
//      {DBSQLTypes.COUNTER, "VARCHAR(12)"}, //, DBSQLTypes.INTEGER}, // Default
      ...
      {SQLParams.AUTO_SEQUENCE_EXTRA, " GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1)"},
      {SQLParams.RESET_AUTO_SEQUENCE, "alter table {table} alter {field} RESTART WITH {start}"},
