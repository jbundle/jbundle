                        ...
                        if (iType == DBConstants.SQL_INSERT_TABLE_TYPE) {
                            ...
                            if ((resultSet != null) && (resultSet.next())) {
                                try {
                                    ...
                                    // Save the counter for possible getLastModified call
                                    m_LastModifiedBookmark = this.getRecord().getHandle(DBConstants.BOOKMARK_HANDLE);
                                    //                                    m_objectID = null;
                                    //                                    m_dataSource = null;
                                } catch (SQLException e) {
                                    Utility.getLogger().warning(e.getMessage() + " on get counter value");
                                    throw this.getDatabase().convertError(e);
                                }
                            }
                        }
