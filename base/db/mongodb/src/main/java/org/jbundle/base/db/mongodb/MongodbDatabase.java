...
/**
 * @(#)MongodbDatabase.java    1.16 19/12/14 Don Corley
 *
 ...
 * <p />MongodbDatabases require a few parameters to use non-default behavior:<br />
 ...
 * @author    Don Corley
 */
public class MongodbDatabase extends BaseDatabase
{
    /**
     ...
     * For debugging.
     */
    public static String JDBC_CATEGORY = MongodbDatabase.class.getName();
    /**
     * Sync
     */
     ...
     */
    public MongodbDatabase(DatabaseOwner databaseOwner, String strDbName, int iDatabaseType)
    {
        this();
...
//                        bFound = true;
    ...
    public BaseTable doMakeTable(Record record)
    {
        ...
        if (((iRawDBType == DBConstants.LOCAL) || (iRawDBType == DBConstants.TABLE))
                && (!bIsQueryRecord))
            table = new MongodbTable(this, record);
...
//            MongodbDatabase db = (MongodbDatabase)env.getDatabase(strDBName, iDatabaseType, null);    // Do NOT pass properties when opening system database
//            Statement queryStatement = db.getMongoDatabase().createStatement();
//
...
//    }
    ...
    public Map<String,String> getDatabaseProperties()
    {
        ...
        ResourceBundle dbProperties = new DBProperties_mongodb();
