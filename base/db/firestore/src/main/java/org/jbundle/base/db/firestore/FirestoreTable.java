...
/**
 * @(#)FirestoreTable.java 1.16 95/12/14 Don Corley
 *
...
/**
 * FirestoreTable - Table for JDBC queries.
 *
 * @version 1.0.0
 * @author    Don Corley
 *
 */
public class FirestoreTable extends BaseTable
{
...
//    protected Document document = null;
     ...
     */
    public FirestoreTable(BaseDatabase database, Record record)
    {
        this();
...
//        document = null;
    ...
    {
        Object data = null;//document.get(field.getFieldName(false, false, true));
...
//        if (collection == null) {
//            if (!((FirestoreDatabase) this.getDatabase()).doesTableExist(tableName)) {
...
//                    }
//            }
//            collection = ((FirestoreDatabase) this.getDatabase()).getMongoDatabase().getCollection(tableName);
//        }
//
//        mongoCursor = null;
//        document = null;
...
//
//            ((FirestoreDatabase) this.getDatabase()).getMongoDatabase().createCollection(tableName, options);
//
//            collection = ((FirestoreDatabase) this.getDatabase()).getMongoDatabase().getCollection(tableName);
//
...
////                    this.setStatement(((FirestoreDatabase)this.getDatabase()).getJDBCConnection().createStatement(), iType);
...
////                }
////                if (this.getStatement(iType) == null)
////                    this.setStatement(((FirestoreDatabase)this.getDatabase()).getJDBCConnection().prepareStatement(strSQL), iType);
...
////            	this.setStatement(((FirestoreDatabase)this.getDatabase()).getJDBCConnection().createStatement(), DBConstants.SQL_CREATE_TYPE);
////
